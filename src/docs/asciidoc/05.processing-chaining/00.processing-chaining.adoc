...
image::processing-application-descriptor.png[width=80%,pdfwidth=80%,align="center"]
...
Data Input Protocol::
The data input protocol may be natively supported by the processing service - otherwise it will need to be staged-in by the Processing Frameowkr.
...
image::application-descriptor-updated.png[width=80%,pdfwidth=80%,align="center"]
...
#TBD - Ref. CEOS OpenSearch Best Practice#
