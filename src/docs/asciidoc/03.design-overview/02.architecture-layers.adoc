...
<<img_architectureLayers>> provides a simplified view that illustrates the broad architecture layes of the Exploitation Platform, in the context of the infrastructure in which it is hosted and the end-users performing exploitation activities.
...
Resource Tier::
The Resource Layer represents the hosting infrastructure and provides the EO data, storage and compute upon which the exploitation is deployed.
