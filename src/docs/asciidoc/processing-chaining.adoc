...
OGC 17-084 (GeoJSON(-LD) metadata encoding for EO collections) <<OGC_17-003r1_17-084>>::
Explore the capabilities of OGC 17-084 to encode application metadata

OGC 17-047 (OGC OpenSearch-EO GeoJSON(-LD) Response Encoding Standard) <<OGC_17-047>>::
